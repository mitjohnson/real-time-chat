  ...
  return (
    ...
    >
      ...
      >
        <span
          className={[
            'absolute text-xs text-gray-500 transition-opacity duration-200',
        ...
        <div
          className={[
            `max-w-xs cursor-pointer rounded-2xl px-4 py-2 text-sm leading-relaxed`,
            `transition-transform duration-200 md:max-w-md lg:max-w-lg`,
            isUserMessage ?
